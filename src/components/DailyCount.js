  ...
  return (
    <Box mt={2} display="flex" flexDirection="row" flexWrap="wrap">
      {pomodorosArr.map((pomodoro) => {return (
        <Box key={pomodoro} className="count-button" style={{background:'#f2f2f2', cursor:'default', borderRadius:10}} m={1}>✔</Box>
      )})}
      <Box className="count-button" style={{background:'#3f51b5', cursor:'default', borderRadius:10, fontWeight:'bold'}} m={1} display="flex" flexDirection="row" flexWrap="wrap">
